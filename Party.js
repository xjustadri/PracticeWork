...
//  step 1 //
function encrytLetter (letter, shift)
{
...
// step 2 //
function encrytMessage (word, shift)
{
...
// Question 1 : Yes the decryted message in the inverse of the original message so when the function is used again it will output the original message. //
