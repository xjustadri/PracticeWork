...
console.log("Riddle Translation:");
...
console.log("Extracted Stones:");
console.log(firstStone);
console.log(sixthStone);
...
function revealPath({ direction, distance }) {
	console.log(`Travel ${distance} units towatd the ${direction}.`);
}
...
const ingredients = [" Featherdust", "FireFlower", "Moonwater", "Starlight", "Ancient Bark"];
